...
//	EngineInterface::addGameLoopTask("Frustum",updateOctTree);
//	EngineInterface::connectKeyboardAction(Escape,exitOctTreeDemo);
//	EngineInterface::addUpdateTask("rebuildOctTree");
//	EngineInterface::addUpdateTask("performTreeFrustumCulling");
//	EngineInterface::addRenderTask("renderSprites");
//	EngineInterface::addRenderTask("renderOctTree");
//
...
//	EngineInterface::addText("Message","Visible objects: ",Vector3D(-750.0f,580.0f,0.0f));
