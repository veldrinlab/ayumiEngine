/**
 * File contains definiton of Segment class.
 * @file    Segment.cpp
...
namespace AyumiEngine
{
	namespace AyumiDestruction
	{
		 ...
		 */
		float Segment::getStartDistance()
		{
			return startDist;
		}
		...
		/**
		 * Method is used to swaps the starting point and the ending point.
		 */	
